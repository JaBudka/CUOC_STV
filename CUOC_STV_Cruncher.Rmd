...
service_chair_winner <- stv(service_chair_1, seats = 2)
```
...
i46_climbs_chair_winner <- stv(i46_climbs_chair_1, seats = 2)
```
...
forest_management_chair_winner <- stv(forest_management_chair_1, seats = 2)
```
